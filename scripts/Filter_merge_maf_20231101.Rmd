...
```{}
data_files <- list.files("/Users/xubr/local_projects/20231017_6drugRes/somatic_pairs_1101run/merged_somatic_variants/pcgr_vcf/", pattern = "*.snvs_indels.tiers.tsv")  

for (ff in data_files){
  print(ff)
  base <- str_split(ff, ".snvs" )
  print(base[[1]][1])
  maf <- read.delim(paste0("/Users/xubr/local_projects/20231017_6drugRes/somatic_pairs_1101run/merged_somatic_variants/pcgr_vcf/",ff), header = TRUE, sep = "\t")
  print(colnames(maf))
  ...
  write.table(short_maf, paste0("/Users/xubr/local_projects/20231017_6drugRes/somatic_pairs_1101run/merged_somatic_variants/pcgr_vcf/",base[[1]][1], "_nofilter.txt"), sep = "\t",row.names = FALSE, col.names = TRUE)
...
```{}
data_files <- list.files("/Users/xubr/local_projects/20231017_6drugRes/germline_1101run/cpsr_vcf/", pattern = "*.snvs_indels.tiers.tsv")  

for (ff in data_files){
  print(ff)
  base <- str_split(ff, ".snvs" )
  print(base[[1]][1])
  maf <- read.delim(paste0("/Users/xubr/local_projects/20231017_6drugRes/germline_1101run/cpsr_vcf/",ff), header = TRUE, sep = "\t")
  print(colnames(maf))
  ...
  write.table(germline_var, paste0("/Users/xubr/local_projects/20231017_6drugRes/germline_1101run/cpsr_vcf/",base[[1]][1], "_filter.txt"), sep = "\t",row.names = FALSE, col.names = TRUE)
}
```
...
## maf filter
  input *.maf
  input from somatic_pairs/merged_somatic_variants/maf
  selected PASS, High or moderate variants, calculated AF

```{}
data_files <- list.files("/Users/xubr/local_projects/20231017_6drugRes/somatic_pairs_1101run/merged_somatic_variants/maf/", pattern = "*.maf")  
for (ff in data_files){
  print(ff)
  base <- str_split(ff, ".maf" )
  print(base[[1]][1])
  
  maf <- read.delim(paste0("/Users/xubr/local_projects/20231017_6drugRes/somatic_pairs_1101run/merged_somatic_variants/maf/",ff), skip=1, header = TRUE, sep = "\t")
  print(colnames(maf))
  ...
  write.table(narrow_maf, paste0("/Users/xubr/local_projects/20231017_6drugRes/somatic_pairs_1101run/merged_somatic_variants/maf/",base[[1]][1], "_no_filter.txt"), sep = "\t",row.names = FALSE, col.names = TRUE)
  
  write.table(short_maf, paste0("/Users/xubr/local_projects/20231017_6drugRes/somatic_pairs_1101run/merged_somatic_variants/maf/",base[[1]][1], "_relexed_filter.txt"), sep = "\t",row.names = FALSE, col.names = TRUE)
...
data_files <- list.files("/Users/xubr/local_projects/20231017_6drugRes/somatic_pairs_1101run/merged_somatic_variants/pcgr_vcf/", pattern = "*.pcgr_acmg.grch38_nofilter.txt")  
for (ff in data_files){
  print(ff)
  ...
  pcgr_Tie123 <- read.delim(paste0("/Users/xubr/local_projects/20231017_6drugRes/somatic_pairs_1101run/merged_somatic_variants/pcgr_vcf/",base[[1]][1],".pcgr_acmg.grch38_nofilter.txt"),header = TRUE, sep = "\t")
  
  maf_filtered <- read.delim(paste0("/Users/xubr/local_projects/20231017_6drugRes/somatic_pairs_1101run/merged_somatic_variants/maf/",base[[1]][1],"_relexed_filter.txt"), header = TRUE, sep = "\t")
  ...
  write.table(maf_pcgr, paste0("/Users/xubr/local_projects/20231017_6drugRes/somatic_pairs_1101run/merged_somatic_variants/maf/",base[[1]][1],".merged_relax_filter_pcgr_annotated_short.txt"), sep = "\t",row.names = FALSE, col.names = TRUE)
...
```{}
setwd("/Users/xubr/local_projects/20231017_6drugRes/reports/")
data_files <- list.files("/Users/xubr/local_projects/20231017_6drugRes/reports/", pattern = "*.merged_relax_filter_pcgr_annotated_IGV.txt")  

for (ff in data_files) {
  base <- str_split(ff, ".merged_relax_filter_pcgr_annotated_IGV.txt" )
  print(base[[1]][1])
  
  maf_temp <- read.delim(paste0("/Users/xubr/local_projects/20231017_6drugRes/reports/",base[[1]][1],".merged_relax_filter_pcgr_annotated_IGV.txt"), header = TRUE, sep = "\t") %>%
  ...
  body_add_par(doc, "FastQ and BAM files are stored at smb://at-s-is2.ncifcrf.gov/ras-intl/static/Genomics/20231101_Res_6lines/")
  body_add_par(doc, " ")
