...
vcf2maf.pl --input-vcf 1_SW1573_parental_S1.germline_no_chr.vcf --output-maf 1_SW1573_parental_S1.germline.vep.FINAL.maf --vep-path $VEP_HOME/bin --vep-data $VEP_CACHEDIR --ref-fasta $VEP_CACHEDIR/GRCh38.fa --ncbi-build GRCh38 --cache-version $VEP_VERSION --vep-forks $SLURM_CPUS_ON_NODE --verbose
...
# cd ./germline/VCF
# check vcf file name and make changes
#sinteractive --cpus-per-task=16
...
do
    ...
    awk '{gsub(/^chr/,""); print}' ${name}.germline.vcf > ${name}.germline_no_chr.vcf
    
    vcf2maf.pl --input-vcf ${name}.germline_no_chr.vcf --output-maf ${name}.germline.vep.FINAL.maf --vep-path $VEP_HOME/bin --vep-data $VEP_CACHEDIR --ref-fasta $VEP_CACHEDIR/GRCh38.fa --ncbi-build GRCh38 --cache-version $VEP_VERSION --vep-forks $SLURM_CPUS_ON_NODE --verbose
