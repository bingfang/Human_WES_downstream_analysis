...
docker container run -it --rm -v /Users/xubr/local_projects/master_PCGR/PCGR/pcgr_data:/root/pcgr_data -v /Users/xubr/local_projects/master_PCGR/PCGR/inputs:/root/inputs -v /Users/xubr/local_projects/master_PCGR/PCGR/outputs:/root/outputs sigven/pcgr:1.0.3 cpsr --input_vcf "/root/inputs/raw_variants.vcf.gz" --pcgr_dir "/root/pcgr_data" --output_dir "/root/outputs" --genome_assembly "grch38" --sample_id "germline" --panel_id 0 --no_docker 
