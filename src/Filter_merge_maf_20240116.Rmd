---
title: "WES analysis of human drug-resistant cell lines"
...
For somatic tumor-normal pair analysis, single nucleotide variants (SNVs) and insertions or deletions (Indels) were identified by 5 callers including mutect, mutect2, strelka, verdict, and varson. The merged SNVs and Indels from 5 callers were annotated by pcgr, vep, and cravat with 11 modules including clinvar, clinvar_acmg, clingen, dbsnp, polyphen2,cosmic, cosmic_gene, civic, civic_gene, cancer_hotspots, cancer_landscape. Variants were classified based on pcgr and vep annotation. For class1-4, AF set as greater than 5%. For class 5 variants AF set as greater than 15%. 
...
```{}
data_files <- list.files("/Users/xubr/local_projects/WES_downstrean_analysis_human/Analysis/pcgr_outputs/", pattern = "*.snvs_indels.tiers.tsv")  

for (ff in data_files){
  print(ff)
  base <- str_split(ff, ".snvs" )
  print(base[[1]][1])
  maf <- read.delim(paste0("/Users/xubr/local_projects/WES_downstrean_analysis_human/Analysis/pcgr_outputs/",ff), header = TRUE, sep = "\t")
  print(colnames(maf))
  ...
  write.table(narrow_maf, paste0("/Users/xubr/local_projects/WES_downstrean_analysis_human/Analysis/pcgr_outputs/",base[[1]][1], "_nofilter.txt"), sep = "\t",row.names = FALSE, col.names = TRUE)
...
```{}
data_files <- list.files("/Users/xubr/local_projects/WES_downstrean_analysis_human/Analysis/CPSR_outputs/", pattern = "*.snvs_indels.tiers.tsv")  

for (ff in data_files){
  print(ff)
  base <- str_split(ff, ".snvs" )
  print(base[[1]][1])
  maf <- read.delim(paste0("/Users/xubr/local_projects/WES_downstrean_analysis_human/Analysis/CPSR_outputs/",ff), header = TRUE, sep = "\t")
  print(colnames(maf))
  ...
  write.table(germline_var, paste0("/Users/xubr/local_projects/WES_downstrean_analysis_human/Analysis/CPSR_outputs/",base[[1]][1], "_filterclass543.txt"), sep = "\t",row.names = FALSE, col.names = TRUE)
}
```
...
## maf filter
  ...
  relax filter: selected High or moderate impact variants, AF>0.05, DP>30

```{}
data_files <- list.files("/Users/xubr/local_projects/WES_downstrean_analysis_human/Analysis/maf/", pattern = "*.maf")  
for (ff in data_files){
  print(ff)
  base <- str_split(ff, ".maf" )
  print(base[[1]][1])
  
  maf <- read.delim(paste0("/Users/xubr/local_projects/WES_downstrean_analysis_human/Analysis/maf/",ff), skip=1, header = TRUE, sep = "\t")
  print(colnames(maf))
  ...
  write.table(narrow_maf, paste0("/Users/xubr/local_projects/WES_downstrean_analysis_human/Analysis/maf/",base[[1]][1], "_no_filter.txt"), sep = "\t",row.names = FALSE, col.names = TRUE)
  
  write.table(short_maf, paste0("/Users/xubr/local_projects/WES_downstrean_analysis_human/Analysis/maf/",base[[1]][1], "_relexed_filter.txt"), sep = "\t",row.names = FALSE, col.names = TRUE)
...
data_files <- list.files("/Users/xubr/local_projects/WES_downstrean_analysis_human/Analysis/CPSR_outputs/", pattern = "*.cpsr.grch38_filterclass543.txt")  

mia <- read.delim("/Users/xubr/local_projects/WES_downstrean_analysis_human/Analysis/CPSR_outputs/2_MiaPaca_S2.cpsr.grch38_filterclass543.txt",header = TRUE, sep = "\t")

SW620 <- read.delim("/Users/xubr/local_projects/WES_downstrean_analysis_human/Analysis/CPSR_outputs/1_SW620_S1.cpsr.grch38_filterclass543.txt",header = TRUE, sep = "\t")

H358 <- read.delim("/Users/xubr/local_projects/WES_downstrean_analysis_human/Analysis/CPSR_outputs/3_NCI_H358_S3.cpsr.grch38_filterclass543.txt",header = TRUE, sep = "\t")
...
for (ff in data_files){
  ...
  ## read in data
  tumor <- read.delim(paste0("/Users/xubr/local_projects/WES_downstrean_analysis_human/Analysis/CPSR_outputs/",base[[1]][1],".cpsr.grch38_filterclass543.txt"),header = TRUE, sep = "\t")
  ...
  write.table(dis_SW, paste0("/Users/xubr/local_projects/WES_downstrean_analysis_human/Analysis/CPSR_outputs/",base[[1]][1],".no_SW620.txt"), sep = "\t",row.names = FALSE, col.names = TRUE)
  write.table(dis_mia, paste0("/Users/xubr/local_projects/WES_downstrean_analysis_human/Analysis/CPSR_outputs/",base[[1]][1],".no_mia.txt"), sep = "\t",row.names = FALSE, col.names = TRUE)
  write.table(dis_H358, paste0("/Users/xubr/local_projects/WES_downstrean_analysis_human/Analysis/CPSR_outputs/",base[[1]][1],".no_H358.txt"), sep = "\t",row.names = FALSE, col.names = TRUE)
...
Implement classification and filter: For class1-4, AF set as greater than 5%. For class 5 variants AF set as greater than 15%. 
...
data_files <- list.files("/Users/xubr/local_projects/WES_downstrean_analysis_human/Analysis/pcgr_outputs/", pattern = "*.pcgr_acmg.grch38_nofilter.txt")  
for (ff in data_files){
  print(ff)
  ...
  pcgr_Tie123 <- read.delim(paste0("/Users/xubr/local_projects/WES_downstrean_analysis_human/Analysis/pcgr_outputs/",base[[1]][1],".pcgr_acmg.grch38_nofilter.txt"),header = TRUE, sep = "\t")
  
  maf_filtered <- read.delim(paste0("/Users/xubr/local_projects/WES_downstrean_analysis_human/Analysis/maf/",base[[1]][1],"_relexed_filter.txt"), header = TRUE, sep = "\t")
  ...
  write.table(maf_pcgr, paste0("/Users/xubr/local_projects/WES_downstrean_analysis_human/Analysis/maf/",base[[1]][1],".merged_relax_filter_pcgr_annotated_short.txt"), sep = "\t",row.names = FALSE, col.names = TRUE)
...
```{}
data_files <- list.files("/Users/xubr/local_projects/WES_downstrean_analysis_human/Analysis/oc_local/", pattern = "*.FINAL.norm.vep.vcf.xlsx")  
for (ff in data_files){
  print(ff)
  ...
  cravat <- read_excel(paste0("/Users/xubr/local_projects/WES_downstrean_analysis_human/Analysis/oc_local/",base[[1]][1],".FINAL.norm.vep.vcf.xlsx"),col_names=TRUE, sheet=2, skip=1)
  ...
  maf_pcgr <- read.delim(paste0("/Users/xubr/local_projects/WES_downstrean_analysis_human/Analysis/maf/",base[[1]][1],".merged_relax_filter_pcgr_annotated_short.txt"), header = TRUE, sep = "\t")
  #maf_filtered <- read.delim("/Users/xubr/local_projects/WES_downstrean_analysis_human/Analysis/maf/1_miapaca2_3um_MRTX849_S1.merged_relax_filter_pcgr_annotated_short.txt", header = TRUE, sep = "\t")
  ...
  write.table(maf_pcgr_cravat, paste0("/Users/xubr/local_projects/WES_downstrean_analysis_human/Analysis/maf/",base[[1]][1],".merged_relax_filter_pcgr_cravat_annotated_short.txt"), sep = "\t",row.names = FALSE, col.names = TRUE)
...
for (ff in data_files){
  ...
  write.table(cpsr_maf, paste0("/Users/xubr/local_projects/WES_downstrean_analysis_human/Somatic_tumor_only/maf/",base[[1]][1],".addtional_cpsr54.txt"), sep = "\t",row.names = FALSE, col.names = TRUE)
...
data_files <- list.files("/Users/xubr/local_projects/WES_downstrean_analysis_human/Reports/", pattern = "*.merged_relax_filter_pcgr_cravat_annotated_short.txt")  

for (ff in data_files) {
  base <- str_split(ff, ".merged_relax_filter_pcgr_cravat_annotated_short.txt" )
  print(base[[1]][1])
  
  maf_temp <- read.delim(paste0("/Users/xubr/local_projects/WES_downstrean_analysis_human/Reports/",base[[1]][1],".merged_relax_filter_pcgr_cravat_annotated_short.txt"), header = TRUE, sep = "\t") 
  
  maf_temp$IGV_Check <-c('unchecked')
  write.table(maf_temp, paste0("/Users/xubr/local_projects/WES_downstrean_analysis_human/Reports/",base[[1]][1],".merged_relax_filter_pcgr_cravat_annotated_IGV.txt"), sep = "\t",row.names = FALSE, col.names = TRUE)
}
...
```{}
setwd("/Users/xubr/local_projects/WES_downstrean_analysis_human/Reports/")
data_files <- list.files("/Users/xubr/local_projects/WES_downstrean_analysis_human/Reports/", pattern = "*.merged_relax_filter_pcgr_cravat_annotated_IGV.txt")  

for (ff in data_files) {
  base <- str_split(ff, ".merged_relax_filter_pcgr_cravat_annotated_IGV.txt" )
  print(base[[1]][1])
  
  maf_temp <- read.delim(paste0("/Users/xubr/local_projects/WES_downstrean_analysis_human/Reports/",base[[1]][1],".merged_relax_filter_pcgr_cravat_annotated_IGV.txt"), header = TRUE, sep = "\t") %>%
